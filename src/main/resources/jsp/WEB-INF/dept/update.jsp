      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="/dept/update" method="post" role="form">
			...
			<div class="form-group">
                ...
                <input class="form-control"    id="dname"  name="dname"value="${dept.dname }"/>
            </div>
			<div class="form-group">
			 	<label class="form-lable mb-2" for="writer">작성자</label>
                <input class="form-control"    id="loc"	   name="loc"  value="${dept.loc}"/>
            </div>
