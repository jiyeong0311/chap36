...
<!-- End Header -->
		...
		<c:choose>
			<c:when test="${param.create ne null}"><p>Dept 추가 성공</p></c:when>
			<c:when test="${param.update ne null}"><p>Dept 수정 성공</p></c:when>
			<c:when test="${param.delete ne null}"><p>Dept 삭제 성공</p></c:when>
                    ...
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${dept.deptno}</h6>
                        </div>
                      </div>
                    </td>
                  </tr>
