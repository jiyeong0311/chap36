      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="/salgrade/create" method="post" role="form">
          
            
              <div class="form-group">
                <input class="form-control"    id="grade" name="grade"   placeholder="salgrade를 입력하세요." value="${salgrade.grade}"/>
              </div>
              <div class="form-group">
                <input class="form-control"    id="losal"  name="losal"  placeholder="losal을 입력하세요." value="${salgrade.losal}"/>
              </div>
              <div class="form-group">
              <input class="form-control"    id="hisal" name="hisal" placeholder="hisal을 입력하세요." value="${salgrade.hisal}"/>
              </div>
