...
<section class="container">
	<form action="/salgrade/create" method="post">
		<div class="mb-3">
			...
			<input class="form-control"    id="grade" name="grade"   placeholder="번호를 입력하세요." value="${salgrade.grade}"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="losal">losal<span>*</span></label>
			<input class="form-control"    id="losal"  name="losal"  placeholder="" value="${salgrade.losal}"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="hisal">hisal</label>
			<input class="form-control"    id="hisal" name="hisal" placeholder="" value="${salgrade.hisal}"/>
		</div>
