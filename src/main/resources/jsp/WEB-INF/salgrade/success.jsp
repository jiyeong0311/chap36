...
<!-- End Header -->
		...
		<c:choose>
			<c:when test="${param.create ne null}"><p>slagrade 추가 성공</p></c:when>
			<c:when test="${param.update ne null}"><p>slagrade 수정 성공</p></c:when>
			<c:when test="${param.delete ne null}"><p>slagrade 삭제 성공</p></c:when>
