    ...
    <section id="features" class="features">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          <h2>User Detail</h2>
          <p>User Detail에서 추가, 수정, 삭제한 내용은 DB에 업데이트됩니다!</p>
          <p>실제로 사용하는 ID, Password 입력하지 마세요!</p>
        </div>
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
		   <div class="btn-group">
				<a href="/user/join" class="btn">추가</a>
				<a href="/user/update?id=${users.id}" class="btn">수정</a>
				<a href="/user/delete?id=${users.id}" class="btn">삭제</a>
			</div>
        </div>
                ...
                <tr>
                  ...
                  <tr>
                   <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">password</th>
                      ...
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${users.password}</h6>
                        </div>
                      </div>
                    </td>
                  </tr>
                ...
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">birth</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${users.birth}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">gender</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${users.gender}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
                ...
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">address</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${users.address}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">tel</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${users.tel}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
...
<nav id="navbar" class="navbar">
  <ul>    
    <li><a class="detailbtn" href="/user/list">List로 돌아가기</a></li>   
    </ul>
</nav>  
    </div>
  </div>
