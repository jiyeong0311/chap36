...
<section class="container">
	<form action="/user/delete" method="post">
		...
		<div class="mb-3">
			...
			<input class="form-control"    id="name"	   name="name" value="${users.name}" disabled="disabled"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="birth">birth</label>
			<input class="form-control"    id="birth"	   name="birth" value="${users.birth}" disabled="disabled"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="gender">gender</label>
			<input class="form-control"    id="gender"	   name="gender" value="${users.gender}" disabled="disabled"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="email">email</label>
			<input class="form-control"    id="email"	   name="email" value="${users.email}" disabled="disabled"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="address">address</label>
			<input class="form-control"    id="address"	   name="address" value="${users.address}" disabled="disabled"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="tel">tel</label>
			<input class="form-control"    id="tel"	   name="tel" value="${users.tel}" disabled="disabled"/>
		</div>
