      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="/city/create" method="post" role="form">
              ...
              <div class="form-group">
                <input class="form-control"    id="countryCode"	   	name="countryCode"    placeholder="나라코드를 입력하세요. ex.'KOR'" value="${city.countryCode}"/>
              </div>
              <div class="form-group">
