    ...
    <section id="features" class="features">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          <h2>City Detail</h2>
          <p>City Detail에서 추가, 수정, 삭제한 내용은 DB에 업데이트됩니다!</p>
        </div>
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
		   <div class="btn-group">
				<a href="/city/create" class="btn">추가</a>
				<a href="/city/update?id=${city.id}" class="btn">수정</a>
				<a href="/city/delete?id=${city.id}" class="btn">삭제</a>
			</div>
        </div>
                    ...
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm"><fmt:formatNumber pattern="0000" value="${city.id}"/></h6>
                        </div>
                      </div>
                    </td>
                  </tr>
