...
<div class="container-fluid py-4">
  <div class="row">
                ...
                <c:forEach var="e" items="${list}">
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm"><a href="/city/detail/${e.id}">${e.name}</a></h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                    ...
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${e.district}</h6>
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm"><fmt:formatNumber pattern="###,###,###,###" value="${e.population}"/></h6>
                        </div>
                      </div>
                    </td>
                  </tr>
	...
	<ul class="list-group list-group-horizontal justify-content-center">
		...
		<li class="list-group-item ${paging.pageNum == 1 ? 'disabled' : ''}">
			<a class="page-link ${paging.pageNum == 1 ? 'text-secondary' : 'text-primary'}" href="/city/page/${paging.navigateFirstPage-1}/ ${paging.pageSize}">&lt</a>
		</li>
	<c:forEach var="n" items="${paging.navigatepageNums}">
		...
		<li class="list-group-item ${paging.pageNum == paging.navigateLastPage ? 'disabled' : ''}">
			<a class="page-link ${paging.pageNum == paging.navigateLastPage ? 'text-secondary' : 'text-primary'}" href="/city/page/${paging.navigateLastPage+1}/${paging.pageSize}">&gt</a>
		</li>
	    <li class="list-group-item ${paging.pageNum == paging.navigateLastPage ? 'disabled' : ''}">
...
<h6 style="padding: 10px;">City Page  <span class="badge bg-secondary">${paging.pageNum}</span></h6>
  </div>
</div>
        </div>
      </div>
