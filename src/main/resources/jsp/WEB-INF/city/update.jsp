      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="/city/update" method="post" role="form">
            <div class="form-group">
	            <label class="form-lable mb-2" for="boardIdx">id</label>
			...
			<div class="form-group">
                ...
                <input class="form-control"    id="name"  			name="name"   value="${city.name}"/>
            </div>
			<div class="form-group">
			 	<label class="form-lable mb-2" for="writer">countryCode</label>
                <input class="form-control"    id="countryCode"	   	name="countryCode"  value="${city.countryCode}"/>
            </div>
              <div class="form-group">
              	<label class="form-lable mb-2" for="content">district</label>
                <input class="form-control"    id="district"	   	name="district" value="${city.district}"/>
              </div>
              <div class="form-group">
              	<label class="form-lable mb-2" for="content">population</label>
                <input class="form-control"    id="population"	   	name="population" value="${city.population}"/>
              </div>
