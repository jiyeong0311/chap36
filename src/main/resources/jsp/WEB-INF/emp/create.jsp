      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="/emp/create" method="post" role="form">
              ...
              <div class="form-group">
                <input class="form-control"    id="gender" name="gender" placeholder="성별을 입력하세요 ex.'M' or 'F'" value="${emp.gender}"/>
              </div>
              <div class="form-group">
                <input class="form-control"    id="job"    name="job"    placeholder="직책을 입력하세요" value="${emp.job}"/>
              </div>
              <div class="form-group">
                <input class="form-control"    id="mgr"    name="mgr" 	 placeholder="mgr를 입력하세요" value="${emp.mgr}"/>
              </div>
              <div class="form-group">
                <input class="form-control"    id="hiredate" name="hiredate" placeholder="입사날짜를 입력하세요 ex.'2020-01-01'" value="${emp.hiredate}"/>
              </div>
              <div class="form-group">
                <input class="form-control"    id="sal" name="sal" 		 placeholder="급여를 입력하세요" value="${emp.sal}"/>
              </div>
              <div class="form-group">
               <input class="form-control"    id="comm" name="comm" 	 placeholder="comm을 입력하세요" value="${emp.comm}"/>
              </div>
              <div class="form-group">
