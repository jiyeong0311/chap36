...
<!-- End Header -->
		...
		<c:choose>
			<c:when test="${param.create ne null}"><p>직원 추가 성공</p></c:when>
			<c:when test="${param.update ne null}"><p>직원 수정 성공</p></c:when>
			<c:when test="${param.delete ne null}"><p>직원 삭제 성공</p></c:when>
                    ...
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${emp.empno}</h6>
                        </div>
                      </div>
                    </td>
                  </tr>
