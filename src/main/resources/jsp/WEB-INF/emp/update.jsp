      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="/emp/update" method="post" role="form">
            <div class="form-group">
	            <label class="form-lable mb-2" for="boardIdx">empno</label>
			...
			<div class="form-group">
			 	<label class="form-lable mb-2" for="boardIdx">ename</label>
			<input class="form-control"    id="ename"  name="ename" value="${emp.ename}" />
            </div>
			<div class="form-group">
			 	<label class="form-lable mb-2" for="writer">gender</label>
			<input class="form-control"    id="gender" name="gender" value="${emp.gender}" />
            </div>
              <div class="form-group">
              	<label class="form-lable mb-2" for="content">job</label>
			<input class="form-control"    id="job"    name="job"  value="${emp.job}" />
              </div>
              <div class="form-group">
              	<label class="form-lable mb-2" for="content">mgr</label>
			<input class="form-control"    id="mgr"    name="mgr"  value="${emp.mgr}" />
              </div>
              <div class="form-group">
              	<label class="form-lable mb-2" for="content">hiredate</label>
			<input class="form-control"    id="hiredate" name="hiredate" value="${emp.hiredate}" />
              </div>
              <div class="form-group">
              	<label class="form-lable mb-2" for="content">sal</label>
			<input class="form-control"    id="sal" name="sal" value="${emp.sal}" />
              </div>
              <div class="form-group">
              	<label class="form-lable mb-2" for="content">comm</label>
			<input class="form-control"    id="comm" name="comm" value="${emp.comm}" />
              </div>
              <div class="form-group">
              	<label class="form-lable mb-2" for="content">deptno</label>
			<input class="form-control"    id="deptno" name="deptno" value="${emp.deptno}" />
              </div>
