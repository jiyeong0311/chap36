    ...
    <section id="features" class="features">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          ...
          <p>Language Detail에서 추가, 수정, 삭제한 내용은 DB에 업데이트됩니다!</p>
        </div>
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
		   <div class="btn-group">
				<a href="/language/create" class="btn">추가</a>
				<a href="/language/update?language=${language.language}" class="btn">수정</a>
				<a href="/language/delete?language=${language.language}" class="btn">삭제</a>
			</div>
			</div>
                ...
                <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm"><fmt:formatNumber pattern="0000" value="${language.countryCode}"/></h6>
                        </div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                   <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">language</th>
                      ...
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${language.language}</h6>
                        </div>
                      </div>
                    </td>
                  </tr>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">isOfficial</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${language.isOfficial}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">percentage</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${language.percentage}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
...
<nav id="navbar" class="navbar">
  <ul>    
    <li><a class="detailbtn" href="/language/list">List로 돌아가기</a></li>   
    </ul>
</nav>  
    </div>
  </div>
