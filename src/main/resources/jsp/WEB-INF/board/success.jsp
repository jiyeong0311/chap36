...
<%-- 		<c:choose> --%>
<%-- 			<c:when test="${param.create ne null}"><p>게시글 작성 성공</p></c:when> --%>
<%-- 			<c:when test="${param.update ne null}"><p>게시글 수정 성공</p></c:when> --%>
<%-- 			<c:when test="${param.delete ne null}"><p>게시글 삭제 성공</p></c:when> --%>
 ...
 <!-- ======= Features Section ======= -->
    <section id="features" class="features">
      <div class="container">
        ...
        <c:choose>
			<c:when test="${param.write ne null}"><p>게시글 작성 성공</p></c:when>
			<c:when test="${param.update ne null}"><p>게시글 수정 성공</p></c:when>
			<c:when test="${param.delete ne null}"><p>게시글 삭제 성공</p></c:when>
			<c:otherwise></c:otherwise>
		</c:choose>
