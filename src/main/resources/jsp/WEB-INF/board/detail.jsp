    ...
    <section id="features" class="features">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          <h2>Board Detail</h2>
          <p>Board Detail에서 추가, 수정, 삭제한 내용은 DB에 업데이트됩니다!</p>
        </div>
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
		   <div class="btn-group ">
				<a href="/board/write" class="btn">추가</a>
				<a href="/board/update?boardIdx=${board.boardIdx}" class="btn">수정</a>
				<a href="/board/delete?boardIdx=${board.boardIdx}" class="btn">삭제</a>
			</div>
        </div>
                    ...
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${board.boardIdx}</h6>
                        </div>
                      </div>
                    </td>
                  </tr>
                ...
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">내용</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${board.content}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
                ...
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">조회수</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${board.hitCnt}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">작성시간</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${fn:substring(board.createDatetime, 11, 19)}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">작성일</th>
                    <td class="align-middle text-center text-sm">
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm">${board.createDate}</h6>
                        </div>
                      </div>
                    </td>                  
                </tr>
...
<nav id="navbar" class="navbar">
  <ul>    
    <li><a class="detailbtn" href="/board/list">List로 돌아가기</a></li>   
    </ul>
</nav>  
    </div>
  </div>
