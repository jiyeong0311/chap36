      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="/board/delete" method="post" role="form">
            <div class="form-group">
	            <label class="form-lable mb-2" for="boardIdx">글 번호</label>
				<input class="form-control" id="boardIdx" name="boardIdx" type="text" value="${board.boardIdx}" disabled="disabled"/>
			...
			<div class="form-group">
                ...
                <input class="form-control" id="title" name="title" type="text"  value="${board.title}" disabled="disabled" />
			...
			<div class="form-group">
                ...
                <input class="form-control" id="writer" name="writer" type="text"  value="${board.writer}" disabled="disabled" />
