...
<%-- 			<input class="form-control"    id="code"  			name="code"  		  placeholder="나라코드를 입력하세요." value="${country.code}" type="hidden"/> --%>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="name">name<span>*</span></label>
			<input class="form-control"    id="name"  			name="name"  		  placeholder="나라코드를 입력하세요." value="${country.name}"/>
<%-- 			<input class="form-control"    id="name"  			name="name"  		  placeholder="나라코드를 입력하세요." value="${country.name}" type="hidden"/> --%>
		</div>
